...
using kmpkg::Test::X64_LINUX;
using kmpkg::Test::X64_WINDOWS;
...
See https://learn.microsoft.com/kmpkg/users/triplets?WT.mc_id=kmpkg_inproduct_cli for more information.
)");
}
