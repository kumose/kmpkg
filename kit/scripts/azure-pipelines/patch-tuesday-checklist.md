...
* [ ] Check for Service 360 alerts (possibly at https://aka.ms/s360 ?) against the service named
      "C++ KMPKG Validation" about vulnerable software we are installing in the VMs and update that.
...
* [ ] Check for any updates possible to `kmpkg-tools.json`. Note that PowerShell currently uses the
