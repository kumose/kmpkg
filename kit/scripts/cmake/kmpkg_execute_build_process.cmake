set(Z_KMPKG_EXECUTE_BUILD_PROCESS_RETRY_ERROR_MESSAGES
...
list(JOIN Z_KMPKG_EXECUTE_BUILD_PROCESS_RETRY_ERROR_MESSAGES "|" Z_KMPKG_EXECUTE_BUILD_PROCESS_RETRY_ERROR_MESSAGES)

function(kmpkg_execute_build_process)
    ...
    if(X_PORT_PROFILE)
        kmpkg_list(PREPEND arg_COMMAND "${CMAKE_COMMAND}" "-E" "time")
        if(DEFINED arg_NO_PARALLEL_COMMAND)
            kmpkg_list(PREPEND arg_NO_PARALLEL_COMMAND "${CMAKE_COMMAND}" "-E" "time")
        endif()
    endif()
    ...
    if(NOT error_code EQUAL "0")
        ...
        if(all_contents MATCHES "${Z_KMPKG_EXECUTE_BUILD_PROCESS_RETRY_ERROR_MESSAGES}")
    ...
    if(NOT error_code EQUAL "0")
        ...
        foreach(log IN LISTS all_logs)
            ...
            if(NOT log_size EQUAL "0")
                ...
                file(APPEND "${Z_KMPKG_ERROR_LOG_COLLECTION_FILE}" "${native_log}\n")
            endif()
        endforeach()
        z_kmpkg_prettify_command_line(pretty_command ${arg_COMMAND})
        message(FATAL_ERROR
